      ...
      <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="flex flex-col overflow-y-auto md:flex-row">
            <div class="h-32 md:h-auto md:w-1/2">
                <img src="<?= base_url('public/images/forgot-password.jpeg') ?>" aria-hidden="true" class="object-cover w-full h-full dark:hidden" alt="Office"/>
            </div>
            <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                <div class="w-full">
                    <h1 class="text-xl font-semibold text-gray-700 dark:text-gray-200">Reset Password 🔒</h1>
                    <p class="mb-2">for <span class="fw-bold">john.doe@email.com</span></p>
                    ...
                    <label class="block text-sm">
                        ...
                        <div class="input-group">
                        <input type="password" name="cpassword" class="form-input" placeholder="***************" />
                        <span class="input-group-text password-visibility cursor-pointer"><i class="fa fa-eye"></i></span>
                        </div>
                    </label>
                        ...
                        <button class="mt-6 w-full py-2 hover:bg-indigo-700 flex items-center justify-center hover:bg-purple-700 focus:shadow-outline focus:outline-none spin" data-send="false">
                            <i class="fa fa-spinner fa-spin"></i> <span class="ml-3">Send Reset Link</span>
                        </button>
                    <?= form_close() ?>
